...
# Image extraction temporarily disabled due to environment restrictions
def extract_images_with_captions(bucket, pdf_key, output_bucket, output_prefix):
    logging.warning("Image extraction skipped: fitz (PyMuPDF) not available in this environment.")
    return "Image extraction skipped in current phase."
